...
package 
{
    ...
    public class xmessage extends Sprite 
    {
        ...
        private static function HugLoaded(_arg_1:*)
        {
            ...
            _local_3.x = (-((750 - (todo.tpw - xatlib.NX(16)))) / 2);
            _local_3.y = 2;
            var _local_4:* = _arg_1.currentTarget.loader.parent;
            var _local_5:* = _local_4.opts;
            _local_5.XO = _local_3.x;
            _local_3.Go(_local_5);
            var _local_6:* = todo.Message[_local_5.v].u;
            var _local_7:* = xatlib.FindUser(_local_6);
            var _local_8:* = todo.Users[_local_7].n;
            if (_local_8.substr(0, 1) == "$")
            {
                _local_8 = _local_8.substr(1);
            };
            _local_8 = ("<c> " + _local_8);
            AddMessageToMc(_local_3, 0, _local_8, -(_local_3.Info.namex), 999, _local_3.Info.namey, _local_6);
            _local_3 = _local_3.Info.av;
            if (_local_3)
            {
                _local_2 = todo.Users[_local_7].a;
                _local_4 = new xAvatar(_local_3, _local_2, "", undefined, _local_7);
                _local_3.scaleX = (_local_3.scaleX * 0.6667);
                _local_3.scaleY = (_local_3.scaleY * 0.6667);
                if (_local_2.charAt(0) == "h")
                {
                    _local_9 = new Sprite();
                    _local_9.graphics.beginFill(0xFF);
                    _local_9.graphics.drawCircle(15, 15, 15);
                    _local_9.graphics.endFill();
                    _local_3.addChild(_local_9);
                    _local_3.mask = _local_9;
                };
            };
        }
