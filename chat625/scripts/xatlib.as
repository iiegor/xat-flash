...
package 
{
    ...
    public class xatlib 
    {
        ...
        public static function mccopyurl_onRelease2(_arg_1:MouseEvent=undefined)
        {
            ...
            xatlib.LoadVariables((todo.Http + "//web.xat.dev/report/data.php"), undefined, _local_2, 1);
            UnfairPopupClose();
            var _local_3:* = ((((todo.Http + "//web.xat.dev/report/report.php?i=") + network.UnfairFile) + "&g=") + network.UnfairGroupName);
        ...
        public static function iMux(_arg_1:*)
        {
            ...
            _local_2 = 0;
            return (((((todo.Http + "//i") + (_local_2 & 1)) + ".xat.dev/web_gear/chat/") + _arg_1));
        }
