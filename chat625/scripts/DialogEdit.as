...
package 
{
    ...
    public class DialogEdit extends Sprite 
    {
        ...
        function SetEmbedCode(_arg_1:Number, _arg_2:String=null, _arg_3:Boolean=false)
        {
            ...
            var _local_4 = ((('<embed src="//www.xat.dev/web_gear/chat/chat.swf" quality="high" bgcolor="#000000" width="540" height="405" name="chat" FlashVars="id=' + _arg_1) + (((_arg_3 == true)) ? ("&gn=" + _arg_2) : "")) + '" align="middle" allowScriptAccess="sameDomain" type="application/x-shockwave-flash" pluginspage="//xat.com/update_flash.shtml" /><br><small><a target="_BLANK" href="//xat.dev/web_gear/');
            if (_arg_3)
            {
                _local_4 = (_local_4 + (((((((((("chat/embed.php?id=" + _arg_1) + "&GroupName=") + _arg_2) + '">Get ') + _arg_2) + ' chat group</a> | <a target="_BLANK" href="//xat.dev/') + _arg_2) + '"> Goto ') + _arg_2) + " website</a></small><br>"));
            } else
            {
                _local_4 = (_local_4 + (('?cb">Get your own Chat Box!</a> <a target="_BLANK" href="//xat.dev/web_gear/chat/go_large.php?id=' + _arg_1) + '">Go Large!</a></small><br>'));
            };
        }
